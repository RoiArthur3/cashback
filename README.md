...
# Site de Cashback Responsive

Ce projet est une application Laravel pour un site de cashback 100% responsive.

## Fonctionnalités prévues
- Inscription et connexion utilisateur
- Liste d'offres cashback
- Suivi des gains
- Interface responsive (Bootstrap)

## Installation
1. Cloner le projet dans `C:\laragon\www\cbm`
...
## Frontend
Le frontend utilise Bootstrap pour garantir une expérience 100% responsive sur tous les appareils.
