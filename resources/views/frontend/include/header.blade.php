...
<header class="bg-gradient-to-r from-blue-900 to-blue-700 text-white shadow-lg sticky top-0 z-50">
    <div class="container mx-auto px-4 py-2 flex flex-col md:flex-row items-center justify-between">
        ...
        <a href="{{ url('/') }}" class="flex items-center space-x-2 mb-2 md:mb-0 order-2 md:order-none">
            <img src="{{ asset('logo.jpg') }}" alt="Logo" class="h-12 w-15">
        ...
        <div class="flex items-center space-x-4 order-4 md:order-none">
            ...
            <!-- Icône Cagnotte -->
            <a href="#" class="p-2 hover:text-yellow-400" title="Cagnotte">
                <i class="fas fa-wallet text-2xl"></i>
            </a>

            <a href="#" class="p-2 hover:text-yellow-400 relative" title="Notifications">
        ...
        <div class="flex items-center space-x-4 order-1 md:order-none mb-2 md:mb-0">
            <div class="relative">
                <button id="userMenuButton" class="flex items-center space-x-2 p-2 hover:text-yellow-400">
                    <img src="{{ auth()->user() ? auth()->user()->avatar_url : asset('avatar.png') }}"
                        alt="Mon compte"
                        class="h-8 w-8 rounded-full border-2 border-yellow-400">
                    <span class="hidden md:inline">{{ auth()->user() ? auth()->user()->name : '' }}</span>
                </button>
    ...
    <nav class="bg-gray-900">
        <div class="container mx-auto px-4">
            <div class="flex justify-center space-x-6 overflow-x-auto py-2 hide-scrollbar">
                <a href="{{ route('lesboutiques') }}" class="whitespace-nowrap px-3 py-2 text-sm font-medium hover:bg-gray-800 rounded">
                    Liste des Boutiques
                </a>

                <a href="#" class="whitespace-nowrap px-3 py-2 text-sm font-medium hover:bg-gray-800 rounded">
                    Nouveautés
                </a>
