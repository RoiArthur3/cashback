...
<div class="container mt-5">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p><strong>Boutique :</strong> {{ $cashback->boutique->nom ?? '-' }}</p>
            ...
            <hr>
            <p class="text-success">Ce cashback a été remboursé par CBM à la boutique concernée.</p>
        </div>
    </div>
    <a href="{{ route('admin.cashbacks.index') }}" class="btn btn-secondary mt-3">Retour à la liste</a>
</div>
@endsection
