...
class PartenaireController extends Controller
{
    ...
    // Liste des produits de la boutique du partenaire
    public function produits()
    {
        $boutique = \App\Models\Boutique::where('user_id', Auth::id())->first();
        $produits = $boutique ? $boutique->produits : collect();
        return view('partenaire.produits', compact('produits'));
    }
    ...
    public function storeProduit(Request $request)
    {
        ...
        $boutique->produits()->create($data);
        return redirect()->route('partenaire.produits')->with('success', 'Produit ajouté !');
    }
